...
const CheckoutForm: React.FC<CheckoutFormProps> = ({clientSecret, handleSetPaymentSuccess}) => {
    ...
    return (<form onSubmit={handleSubmit} id="payment-form">
        ...
        <AddressElement options={{mode: 'shipping', allowedCountries: ["INDIA","US","KE"], }}/>
        <h2 className="font-semibold mt-4 mb-2">Payment Information</h2>
        <PaymentElement id="payment-element" options={{layout: "tabs" }}/>
        <div className="py-4 text-center text-slate-700 text-xl font-bold"> Total: {formatedPrice}</div>
